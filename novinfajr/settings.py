"""
Django settings for novinfajr project.
...
SECRET_KEY = 'django-insecure-i#*i@@$pj3%kxe*%k64(3bm!=11dkw2cyn(sps04@ma9fk#gg-'
...
WSGI_APPLICATION = 'novinfajr.wsgi.application'
